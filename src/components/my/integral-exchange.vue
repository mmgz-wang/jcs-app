  ...
  <div id="integral_exchange">
    ...
    <div class="exchange_wrap">
        <dl class="exchange_hd">
            <dt><img src="../../common/img/detil_defaultBG.png" alt=""></dt>
            <dd>
                {{price}}元文章解锁卷
                <p>{{integral}}积分</p>
            </dd>
        ...
        <ul class="li">
            ...
            <li>
                账户共 <span>{{userIntegral}}</span> 积分 <span @click="allExchange"> 积分全部兑换</span>
           </li>
        </ul>
        <div class="foot">
            总计 <span>{{integral*num}}积分</span>
...
export default {
  ...
  methods: {
    ...
    subExchange () {
        ...
        this.$http.jsonp(
          Common.baseURI().host + '/User/IntegralExchange',
            {
                params:{
                    userId:this.shareFn.getUserId(),
                    token:this.shareFn.getSecurityCode(),
...
#integral_exchange {
  ...
  .exchange_wrap{
      ...
      .li{
          margin-top: 10px;background: #ffffff;padding-left: 15px;
          li{
              line-height: 49px;line-height: 49px;border-bottom: 1px solid #e0e0e0;
              input{
                  outline: none;border: none;height: 100%;padding-left: 10px;font-size: 15px;
              }
          }
          li span{
              color: #e9311d;
      ...
      .foot{
          background: #ffffff;line-height: 52px;position: fixed;bottom: 0;left: 0;width: 100%;
          padding: 0 15px;
          button{
              background: #e9311d;color: #ffffff;height: 100%;padding: 0 25px;outline: none;
              border: none;position: absolute;right: 0;top: 0;font-size: 15px;
          }
          span{
              color: #e9311d;
          }
