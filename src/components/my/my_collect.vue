  ...
  methods: {
    ...
    getData(id,done) {
      ...
      this.$nextTick(function () {
        this.$http.jsonp(
          'http://www.jingcaishuo.com/article/list/collect?time=' + Math.random(),
          { params:{language: 'M',userId:sharefn.getUserId(),securityCode:sharefn.getSecurityCode(),articleId: '0',}}
        ).then(function(res) {
          console.log(res);
