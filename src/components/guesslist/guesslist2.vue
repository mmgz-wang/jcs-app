      ...
      <div class="scroll-wrap">
        ...
        <div class="concnet" v-for="(guess,index) in guessMatchData">
          ...
          <div class="name">{{guess.match_league}}
            ...
            <span class="time">{{guess.end_time_hm}}</span></div>
          <div class="vsname">
            {{guess.match_teams}}
          ...
          <div class="contrast">
            <div class="contc" :class="oddIndex%2==0?'':'contr'" v-for="(odd,oddIndex) in guess.odds">
              <div class="num">{{odd.handicap_name}}<span>{{odd.handicap_plan}}</span></div>
              <div class="cnt_txt">
                <ul>
                  <li @click="teamClick(odd, odd.value1_name,odd.value1_plan,'up')">{{odd.value1_name}}
                    {{odd.value1_plan}}
                  </li>
                  <li @click="teamClick(odd, odd.value2_name,odd.value2_plan,'down')">{{odd.value2_name}}
                    {{odd.value2_plan}}
                  </li>
                </ul>
              </div>
